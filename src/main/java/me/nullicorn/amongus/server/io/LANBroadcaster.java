package me.nullicorn.amongus.server.io;
...
public class LANBroadcaster extends ChannelInboundHandlerAdapter {
  ...
  private class BroadcastTask extends TimerTask {
    ...
    /**
     * Create a new broadcast message. This will be received by other Among Us clients on the LAN that are looking for a local game.
     *
